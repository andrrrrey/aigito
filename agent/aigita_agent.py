            ...
            if context:
                ...
                chat_ctx.add_message(
                    ...
                    content=(
                        ...
                        "используй эти факты в ответе, оставаясь в рамках своей личности и правил поведения:\n"
                        + context
                    ),
                )
                ...
                if web_context:
                    ...
                    chat_ctx.add_message(
                        role="system",
                        content=(
                            "Результаты веб-поиска — используй эти данные в ответе, "
                            "оставаясь в рамках своей личности и правил поведения:\n" + web_context
                        ),
                    )
                else:
